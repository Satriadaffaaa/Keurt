...
<section class="content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#imageModal{{$payment->id}}">
                                Lihat Bukti
                            </button>
                        </td>
    ...
    <div class="btn-group">
        ...
        <a href="{{ url('edit-payment-page/edit/'.$payment->id) }}" class="btn btn-primary btn-sm">
        ...
        @endif
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="imageModal{{$payment->id}}" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel{{$payment->id}}" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="{{ Storage::url($payment->image) }}" class="img-fluid" alt="Payment Image">
                            </div>
                        </div>
                    </div>
                </div>
